      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/admin/available_jobs">
          <Card className="h-full hover:shadow-lg transition-all duration-300 border-0 shadow-md bg-gradient-to-br from-white to-green-50 cursor-pointer overflow-hidden group">
            ...
            <CardHeader>
              <div className="flex items-center mb-2">
                <div className="h-10 w-10 rounded-full bg-green-100 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-300">
                  <Briefcase className="h-5 w-5 text-green-600" />
                </div>
                <CardTitle className="text-xl">Available Jobs</CardTitle>
              </div>
              <CardDescription>
                Create and manage job positions for applicants
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
                Add new job positions, manage slots, and update job details for
